...
class BartParser:
    def __init__(self):
        ...
        self.tokenizer = BartTokenizer.from_pretrained('deathkun/bart-cv-parser')
        self.config = BartConfig.from_pretrained('deathkun/bart-cv-parser')
        self.model = BartForConditionalGeneration.from_pretrained('deathkun/bart-cv-parser', config=self.config)
    ...
    def parse(self, raw_text):
        ...
        output_ids = self.model.generate(input_ids, min_length=100)
